...
exports.handler = async function (event) {
  ...
  try {
    ...
    // --- Chiamata a Claude per la bozza di analisi ---
    ...
    // --- Invio email con la bozza a chi gestisce Redflegghed ---
    sgMail.setApiKey(process.env.SENDGRID_API_KEY);

    await sgMail.send({
      to: process.env.OWNER_EMAIL, // fa-brix@live.it, impostata come env var
      from: process.env.SENDER_EMAIL, // mittente verificato su SendGrid
